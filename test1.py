...
OPENID_PROVIDER_NAME = 'Google app'
OPENID_PROVIDER_URL ='https://www.google.com/accounts/o8/site-xrds?hd=pagalguy.com'
...
class OpenIDRequestHandler(BaseHTTPRequestHandler):
    ...
    def getSession1(self):
      if self.session is not None:
            return self.session
      else:
        return {'id': randomString(16, '0123456789abcdef')}
